...
//const int XP=6;   // Touch X Pluse
//const int XM=A2;  // Touch X Minus
//const int YP=A1;  // Touch Y Pluse
//const int YM=7;   // Touch Y Minus

const int XP=7;   // Touch X Pluse
const int XM=A1;  // Touch X Minus
const int YP=A2;  // Touch Y Pluse
const int YM=6;   // Touch Y Minus
